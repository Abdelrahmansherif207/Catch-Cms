...
export const invoiceStatusStyles: Record<InvoiceStatus, string> = {
  ...
  generating: 'border-transparent bg-info-soft text-info',
  generated: 'border-transparent bg-info-soft text-info',
  pdf_generating: 'border-transparent bg-warning-soft text-warning',
  ready: 'border-transparent bg-success-soft text-success',
  failed: 'border-transparent bg-destructive-soft text-destructive',
  verified: 'border-transparent bg-success-soft text-success',
  downloaded: 'border-transparent bg-info-soft text-info',
  printed: 'border-transparent bg-muted text-muted-foreground',
  corrected: 'border-transparent bg-warning-soft text-warning',
