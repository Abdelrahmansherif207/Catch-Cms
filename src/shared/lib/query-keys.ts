export const queryKeys = {
  ...
  orders: {
    ...
    myOrders: {
      ...
      list: (params: Record<string, any>) => ['orders', 'my', 'list', params] as const,
      invoice: (uuid: string) => ['orders', 'my', 'invoice', uuid] as const,
    },
  },
  invoices: {
    ...
    myInvoices: {
      all: ['invoices', 'my'] as const,
      list: (params: Record<string, any>) => ['invoices', 'my', 'list', params] as const,
      detail: (uuid: string) => ['invoices', 'my', 'detail', uuid] as const,
    },
  },
  users: {
    all: ['users'] as const,
  ...
  coupons: {
    ...
    assignments: {
      ...
      list: (couponId: number, params: Record<string, any>) => ['coupons', couponId, 'assignments', params] as const,
    },
  },
  reviews: {
