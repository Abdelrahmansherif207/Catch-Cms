export const queryKeys = {
  ...
  categories: {
    ...
    allList: () => ['categories', 'list', 'all'] as const,
  ...
  brands: {
    ...
    allList: () => ['brands', 'list', 'all'] as const,
  ...
  sliders: {
    ...
    allList: () => ['sliders', 'list', 'all'] as const,
  ...
  flashSales: {
    ...
    allList: () => ['flash-sales', 'list', 'all'] as const,
  ...
  banners: {
    ...
    allList: () => ['banners', 'list', 'all'] as const,
  ...
  attributes: {
    ...
    allList: () => ['attributes', 'list', 'all'] as const,
